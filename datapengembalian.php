...
$userPustakawan = $pustakawan->cariByIdPustakawan($_SESSION['user_id']);$pengembalian = new Pengembalian();
if (isset($_GET['id_peminjaman'])) {
    $id_peminjaman = $_GET['id_peminjaman'];
    $result = $pengembalian->hapus($id_peminjaman);
}
$isiData = $pengembalian->tampilDataPengembalian();
?>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="datapengembalian.php">Pengembalian</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="laporan.php">Laporan</a>
                    </li>
                </ul>
                <form class="d-flex" role="search" onsubmit="searchPengembalian(event)">
                    <input class="form-control me-2" type="search" id="searchInput" placeholder="Cari pengembalian..." aria-label="Search">
                    <button class="btn btn-outline-light" type="submit">Cari</button>
                </form>
                <script>
                function searchPengembalian(event) {
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-2">
            ...
            <a href="tambahpengembalian.php" class="btn btn-primary">Tambah</a>
            <a href="datapengembalian.php" class="btn btn-secondary ms-2">Refresh</a>
                ...
                <tbody>
                    ...
                    foreach ($isiData as $data): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editpengembalian.php?id_peminjaman=<?php echo $data['id_peminjaman'] ?>" class="btn btn-warning">Edit</a>
                                <a href="datapengembalian.php?id_peminjaman=<?php echo $data['id_peminjaman'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data <?php echo $data['nama_anggota'] ?>?')" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
