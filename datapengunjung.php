...
$userPustakawan = $pustakawan->cariByIdPustakawan($_SESSION['user_id']);$pengunjung = new Pengunjung();
$status = "";
if (isset($_GET['nis'])) {
    $nis = $_GET['nis'];
    $result = $pengunjung->hapus($nis);
}
$isiData = $pengunjung->tampilDataPengunjung();
?>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="datapengunjung.php">Pengunjung</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex" role="search" onsubmit="searchPengunjung(event)">
                    <input class="form-control me-2" type="search" id="searchInput" placeholder="Cari pengunjung..." aria-label="Search">
                    <button class="btn btn-outline-light" type="submit">Cari</button>
                </form>
                <script>
                function searchPengunjung(event) {
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-2">
            ...
            <a href="tambahpengunjung.php" class="btn btn-primary">Tambah</button>
                <a href="datapengunjung.php" class="btn btn-secondary ms-2">Refresh</a>
                    ...
                    <tbody>
                        ...
                        foreach ($isiData as $data): ?><!-- Memulai perulangan -->
                            <tr>
                                ...
                                <td>
                                    <a href="editpengunjung.php?nis=<?php echo $data['nis'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="datapengunjung.php?nis=<?php echo $data['nis'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data <?php echo $data['nama'] ?>?')" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
