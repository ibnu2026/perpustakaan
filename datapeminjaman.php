...
$userPustakawan = $pustakawan->cariByIdPustakawan($_SESSION['user_id']);$peminjaman = new Peminjaman();
$status = "";
if (isset($_GET['id_peminjaman'])) {
    $id_peminjaman = $_GET['id_peminjaman'];
    $result = $peminjaman->hapus($id_peminjaman);
}
$isiData = $peminjaman->tampilDataPeminjaman();
?>
...
<body>
    <nav class="navbar navbar-expand bg-primary" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search" onsubmit="searchPeminjaman(event)">
                    <input class="form-control me-2" type="search" id="searchInput" placeholder="Cari peminjaman..." aria-label="Search">
                    <button class="btn btn-outline-light" type="submit">Cari</button>
                </form>
                <script>
                function searchPeminjaman(event) {
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-2">
            ...
            <a href="tambahpeminjaman.php" class="btn btn-primary">Tambah</button>
                <a href="datapeminjaman.php" class="btn btn-secondary ms-2">Refresh</a>
                    ...
                    <tbody>
                        ...
                        foreach ($isiData as $data): ?><!-- Memulai perulangan -->
                            <tr>
                                ...
                                <td>
                                    <a href="editpeminjaman.php?id_peminjaman=<?php echo $data['id_peminjaman'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="datapeminjaman.php?id_peminjaman=<?php echo $data['id_peminjaman'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data <?php echo $data['nama_anggota'] ?>?')" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
