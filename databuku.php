...
if (isset($_GET['kode_buku'])) {
    ...
    $result = $buku->hapus($kode_buku);
}
$isiData = $buku->tampilDataBuku();
?>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="databuku.php">Buku</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex" role="search" onsubmit="searchBuku(event)">
                    <input class="form-control me-2" type="search" id="searchInput" placeholder="Cari buku..." aria-label="Search">
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-2">
            ...
            <a href="tambahbuku.php" class="btn btn-primary">Tambah</button>
                <a href="databuku.php" class="btn btn-secondary ms-2">Refresh</a>
                    ...
                    <tbody>
                        ...
                        foreach ($isiData as $data): ?><!-- Memulai perulangan -->
                            <tr>
                                ...
                                <td>
                                    <a href="editbuku.php?kode_buku=<?php echo $data['kode_buku'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="databuku.php?kode_buku=<?php echo $data['kode_buku'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data <?php echo $data['judul'] ?>?')" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
